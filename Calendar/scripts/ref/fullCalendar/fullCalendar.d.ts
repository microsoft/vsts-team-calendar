...
declare module FullCalendar {
    ...
    export interface Options {
        ...
        eventRender?: (event: EventObject, element: JQuery, view: View) => void;
        eventAfterRender?: (event: EventObject, element: JQuery, view: View) => void;
    ...
    export interface EventObject extends EventCommon {
        id?: string|number;
        title: string;
        allDay?: boolean;
        start: Date|string;
    ...
    export interface EventSourceOptions extends EventCommon {
        allDayDefault?: boolean;
        eventDataTransform?: (eventData: any) => EventObject;
        lazyFetching?: boolean;
    ...
    export interface EventSource extends JQueryAjaxSettings, EventSourceOptions {
        // An event source can be one of the following
        events?: EventObject[] | ((start: Date, end: Date, callback: ((events: EventObject[]) => void)) => void);
        url?: string;
        googleCalendarId?: string;
        
        // The following are used to customize the AJAX request when a url is given as the event source.
        startParam?: string;
        endParam?: string
