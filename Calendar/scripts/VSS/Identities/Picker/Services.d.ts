...
export declare class IdentityService extends Service.VssService {
    ...
    **/
    getIdentities(prefix: string, identityScope: IdentityScope, identityType: IdentityType, successCallback: (queryTokenResult: Identities_Picker_RestClient.QueryTokenResultModel) => void, errorCallback?: (errorData?: any) => void, options?: IIdentityServiceOptions): void;
    /**
    ...
    *   @param  errorCallback:      This is called for each error received from either the controller or one of the federated services
    **/
    getIdentityImages(identities: Identities_Picker_RestClient.IIdentity[], identityScope: IdentityScope, identityType: IdentityType, successCallback: (images: IDictionaryStringTo<string>) => void, errorCallback?: (errorData?: any) => void, options?: IIdentityServiceOptions): void;
}
