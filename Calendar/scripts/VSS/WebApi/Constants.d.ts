export declare module AppStoreNames {
    var BuiltIn: string;
    var Me: string;
}
export declare module AuthenticationResourceIds {
...
export declare module OperationsResourceIds {
...
export declare module ServiceInstanceTypes {
    var SPS: string;
    var TFS: string;
