...
export declare class WorkHttpClient extends VSS_WebApi.VssHttpClient {
    ...
    /**
     * Update cumulative flow chart
     *
     * @param {{ [key: string] : any; }} settings - The settings to to be updated for the chart
     * @param {TFS_Core_Contracts.TeamContext} teamContext - The team context for the operation
     * @param {string} board - Identifier for board, either category plural name (Eg:&quot;Stories&quot;) or Guid
     * @param {string} boardCategoryReferenceName - board category reference name, used to save the team settings
     * @return IPromise<{ [key: string] : any; }>
     */
    updateCumulativeFlowChart(settings: {
        [key: string]: any;
    }, teamContext: TFS_Core_Contracts.TeamContext, board: string, boardCategoryReferenceName: string): IPromise<{
        [key: string]: any;
    }>;
    /**
     * @param {TFS_Core_Contracts.TeamContext} teamContext - The team context for the operation
     ...
     * @return IPromise<void>
     */
    postTeamIteration(iterationId: string, teamContext: TFS_Core_Contracts.TeamContext): IPromise<void>;
    /**
     * @param {TFS_Core_Contracts.TeamContext} teamContext - The team context for the operation
     * @param {string} board
