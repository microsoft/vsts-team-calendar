...
export interface IIdentityPickerDropdownOptions extends Identities_Picker_Services.IIdentityServiceOptions {
    ...
    **/
    identityType?: Identities_Picker_Services.IdentityType;
    /**
    *   type of identities - one or more of User or Group
    **/
    identityScope?: Identities_Picker_Services.IdentityScope;
    /**
    ...
    **/
    ...
    /**
    *   the width of the dropdown control. Default is max(container width, 400px)
    **/
    width?: number;
    /**
